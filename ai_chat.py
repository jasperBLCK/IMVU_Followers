...
SYSTEM_PROMPT = (
    ...
    "Главное правило: настоящий человек НЕ отвечает на каждое сообщение. "
    "Отвечай только если обращаются к тебе, задают вопрос всем, или тема "
    "реально интересная. На спам, приветствия ботов, рекламу и чужие личные "
    "диалоги — молчи.\n"
